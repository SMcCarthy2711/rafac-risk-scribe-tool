...
const exportToPDF = async (assessment: RiskAssessment) => {
  try {
    ...
    // Main risk table headers
    const riskHeaders = [
      { content: '(a)\nRef', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(b)\nActivity / Element\n(Step 1a)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(c)\nHazards identified\n(Step 1b)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(d)\nWho or what might be harmed and how\n(Step 2)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(e)\nExisting control measures\n(Step 3a)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(f)\nL\n(1-5)\n(Step 3b)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(g)\nI\n(1-5)\n(Step 3c)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(h)\nRisk Rating\n(L x I)\n(Step 3d)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(i)\nIs risk acceptable?\n– Refer to\nRisk Score\nCalculation\nabove', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(j)\nReasonable additional\ncontrols that can be\nimplemented to reduce\nrisk to ALARP\n(Step 3f)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(k)\nL\n(1-5)\n(Step 3g)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(l)\nI\n(1-5)\n(Step 3h)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(m)\nRisk Rating\n(L x I)\n(Step 3i)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } },
      { content: '(n)\nList required action(s)\nto instigate controls\n(Who, When and How)\n(Step 3j)', styles: { halign: 'center', valign: 'middle', fontStyle: 'bold' } }
    ];
